...
Source of https://www.ams-startup-lab.org. A static site (Astro) whose content lives in `data/`. A weekly Claude routine proposes new publications, news, and events as pull requests. A person approves by merging and rejects by closing.
